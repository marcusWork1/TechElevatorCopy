...
-- if it doesn't: 
--
-- 1. Create one using pgAdmin
--
--     - OR -   
--
-- 2. Create one from a Windows command prompt:
--    a. Open a Windows command prompt (NOT GitBash!)
--    b. Issue the command: createdb -U postgres apireview
