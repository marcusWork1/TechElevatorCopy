...
public class CardDeck {
	 ...
	 ***************************************************************************************************/
    // LinkedList used to represent the Queue so we can use
	//            Collections class methods to manipulate the Queue
	LinkedList<PlayingCard> deckOfCards = new LinkedList();  // Define a Queue to hold PlayingCards
