------------------------------------------------------------------------------------------------------
-- This query does not reference tables in any specfic database
------------------------------------------------------------------------------------------------------
-- show today's date
...
select '12/25/2023' - current_date as day_until_Christmas
;
-- be aware of result when calculating days between dates() - date() 
select  date('12/31/2023') - date('12/01/2023')  as days_in_December
;
...
select date('10/30/2020') + interval '1 day' as month_w_31_days
      ,date('11/30/2023') + interval '1 day' as month_w_30_days
;
-- SQL date atrithmetic knows about leap years
select date('02/27/2023') + interval '2 days' as non_leap_year
