...
public class ConsoleService {
    ...
    //  receive an array of reservations to display and a hotelID
    public void printReservations(Reservation[] reservations, int hotelId) {
        // Set the message displayed to the user to indicate whether all reservations
        //         are being shown or just ones for a particular hotel
        //         based on the hotelId parameter. if hotelId is -1, all reservations
        //                                                    is not -1 - particular hotels reservations
        ...
        // alternative:
        //   if(hotelId == -1) {
        //     msg = "All Reservations;
        //   else {
        //     msg = "Reservations for hotel: " + hotelId;
        //   }

        System.out.println("--------------------------------------------");
        System.out.println(msg);  // display the message determined based on hotelId
     //  System.out.println(hotelId == -1 ? "All Reservations" : "Reservations for hotel: " + hotelId);
        System.out.println("--------------------------------------------");
