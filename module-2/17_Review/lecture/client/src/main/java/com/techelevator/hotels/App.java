...
public class App {
    ...
    private void handleLogin() {
        ...
        // Pass the username and password to Authentication service to log them in
        String token = authenticationService.login(username, password);
        if (token != null) {                  // if login was successful
            hotelService.setAuthToken(token); //    store the JWT in the HotelService
        } else {
            consoleService.printErrorMessage();
        }
    }
