...
export default {
  ...
  methods: {
    viewCardDetails(cardID) {
      // tell the Vue router to go to another page 
      // .$router.push(path for page to be displayed with any parameters)
      // the path path specified in .push must be defined in the index.js for the router
