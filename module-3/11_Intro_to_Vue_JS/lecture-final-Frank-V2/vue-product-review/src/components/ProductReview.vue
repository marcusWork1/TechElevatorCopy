<template>  <!-- Our html goes here -->
    <div class='main'>  <!-- Place our code in the main part of this page -->
       ...
       <div class="well-display">  
         <!-- class="name" is used to allow CSS to style a group of elements -->
         <!-- class="well" there should be some CSS to style all class="well" element -->
           <div class="well">   <!-- Average rating box    --> 
           <!-- averageRating is a computed value in the computed section of the JavaScript -->
           <!-- it's automaticallu calculated by Vue when data changes in the JavaScript    -->
       ...
       <!-- v-for will generate one html element (<div) for each element in the array        -->
       <div class='review' v-for="aReview in reviews" v-bind:key="aReview.id">  
         <!-- Hold the display of the product review data -->
          ...
          <div class="rating">
             <img src="../assets/star.png" v-for="n in aReview.rating" v-bind:key="n">
          </div>
...
div.main div.well-display div.well { /* styling for divs with class="main" class="well-displa" class="well" */ 
