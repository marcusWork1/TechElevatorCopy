...
public class FranksJavaLambdaExpressionsExamples {
    ...
    public static void setup() {
        ...
        System.out.println("-".repeat(55) + "\nWelcome to Frank's Lambda Expressions Example\n" + "-".repeat(55));
    ...
    public static void takeDown() {
        System.out.println("-".repeat(55) + "\nThanks for visiting Frank's Lambda Expressions Example\n" + "-".repeat(55));
    }

} // End of FranksLambdaExpressionsExamples class
