...
import com.techelevator.MyFileReader;
...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		//catch(Exception name-for-exception-block)
		} catch(ArrayIndexOutOfBoundsException e) { // catch the Exception and name the name exception block e
			// Flow of control resumes here after the Exception is thrown
			// Display and message and resume execution
		...
		try {
			...
			// an exception thrown in any method called from the try block can be caught by teh try block
	...
	private static void doSomethingDangerous() {
		...
		for(int i = 0; i < 10; i++) {  // index will become larger than the array size
