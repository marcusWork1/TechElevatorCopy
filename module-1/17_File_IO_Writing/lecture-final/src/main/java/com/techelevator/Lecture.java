...
public class Lecture {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 *
		 * Once you have a File object you can use it find our things related to the file
		 */
		...
		// To create a new file from a program
		//
		//  1. Define a File object for the file
		//  2. Use the File object to call the createNewFile() method
		//     if you use createNewFile() on an existing file, it will destroy the existing file
		//     consider checking to see if a file already exists before createNewFile()
